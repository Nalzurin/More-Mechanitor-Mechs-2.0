...
namespace MoreMechanitorMechs
{
    ...
    [HarmonyPatch]
    public static class MechFriendly_JobDriver_Research
    {
        private static MethodBase TargetMethod()
        {
            return AccessTools.Method(AccessTools.Inner(typeof(JobDriver_Research), "<>c__DisplayClass6_0"), "<MakeNewToils>b__0");
        }
